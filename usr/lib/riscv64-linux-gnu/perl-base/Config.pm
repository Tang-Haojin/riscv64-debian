...
tie %Config, 'Config', {
    archlibexp => '/usr/lib/riscv64-linux-gnu/perl/5.32',
    ...
    exe_ext => '',
    inc_version_list => '5.32.0 5.32.0/riscv64-linux-gnu-thread-multi',
    intsize => '4',
    ...
    scriptdir => '/usr/bin',
    sitearchexp => '/usr/local/lib/riscv64-linux-gnu/perl/5.32.1',
